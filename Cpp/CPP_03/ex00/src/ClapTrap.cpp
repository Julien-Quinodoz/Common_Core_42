...
/*   Updated: 2025/05/19 12:09:44 by jquinodo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "\033[38;5;177mDefault constructor\033[0m" << std::endl;
...
{
	std::cout << "\033[38;5;177mParametric constructor for name : \033[0m" << this->_name << std::endl;
	this->_hit_pts		= 10;
	this->_energy_pts	= 10;
	this->_attack_pts	= 0;
}
...
ClapTrap::~ClapTrap(void)
{
	std::cout << "\033[38;5;177mDestructor for : \033[0m" << this->_name << std::endl;
}
...
void	ClapTrap::attack(const std::string &target)
{
	...
	std::cout << "\e[48;5;153mClapTrap:\033[0m " << this->_name << "\033[38;5;210m attacks \033[0m" << target << "\e[48;5;217m, causing " << this->_attack_pts << " pts of domage !\033[0m" << std::endl;
	this->_energy_pts--;
}
...
{
	if(this->_hit_pts < 1 || this ->_energy_pts < 1)
	{
		std::cout << "\e[48;5;153mClapTrap:\033[0m " << this->_name << " \e[48;5;216m💀 doesn't have any hit points or energy points left.\033[0m" << std::endl;
		return;
	}
	std::cout << "\e[48;5;153mClapTrap:\033[0m " << this->_name << " \e[48;5;183mwon " << amount << " hit pts ! now have : \033[0m" << this->_hit_pts + amount << std::endl;
	this->_hit_pts += amount;
	this->_energy_pts--;
}
