...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/13 19:40:39 by jquinodo          #+#    #+#             */
/*   Updated: 2025/01/14 12:48:04 by jquinodo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

static void	current_index(t_stack_node *stack)
{
	int	i;
	int	median;
...
static void	set_cheapest_a(t_stack_node *stack)
{
	long			cheapest_value;
